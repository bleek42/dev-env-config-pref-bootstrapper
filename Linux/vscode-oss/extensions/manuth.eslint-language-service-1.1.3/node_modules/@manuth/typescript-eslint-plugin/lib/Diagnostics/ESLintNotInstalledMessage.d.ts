 ...
 */
export declare class ESLintNotInstalledMessage extends Diagnostic {
    /**
     ...
     */
    private static localCommands;
    /**
     * The commands for installing the linter globally.
     */
    private static globalCommands;
    /**
     ...
     */
    constructor(plugin: Plugin, file: SourceFile, category?: DiagnosticCategory);
    /**
