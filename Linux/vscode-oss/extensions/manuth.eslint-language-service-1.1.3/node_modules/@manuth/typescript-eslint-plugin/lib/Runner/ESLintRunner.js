...
const LabeledLogger_1 = require("../Logging/LabeledLogger");
...
class ESLintRunner {
    ...
    get RunnerLogger() {
        if (this.Config.LogLevel !== LogLevel_1.LogLevel.None) {
            return new LabeledLogger_1.LabeledLogger(this.RealLogger);
        }
        else {
            return null;
        }
    ...
    RunESLint(file) {
        ...
        if (!this.document2LibraryCache.has(file.fileName)) {
            (_b = this.RunnerLogger) === null || _b === void 0 ? void 0 : _b.Log("RunESLint", `Preparing to load the \`${Constants_1.Constants.ESLintPackageName}\` library`);
            this.document2LibraryCache.set(file.fileName, this.LoadLibrary(file.fileName));
        }
        (_c = this.RunnerLogger) === null || _c === void 0 ? void 0 : _c.Log("RunESLint", `Loading the \`${Constants_1.Constants.ESLintPackageName}\` library`);
        // eslint-disable-next-line deprecation/deprecation
        let linter = (_d = this.document2LibraryCache.get(file.fileName)) === null || _d === void 0 ? void 0 : _d();
        if (!linter) {
            (_e = this.RunnerLogger) === null || _e === void 0 ? void 0 : _e.Log("RunESLint", `The \`${Constants_1.Constants.ESLintPackageName}\` package is not installed!`);
            ...
            (_f = this.RunnerLogger) === null || _f === void 0 ? void 0 : _f.Log("RunESLint", `Successfully loaded the \`${Constants_1.Constants.ESLintPackageName}\` package`, LogLevel_1.LogLevel.Verbose);
        ...
        if (!this.packageManagerPaths.has(packageManager)) {
            ...
            switch (packageManager) {
                ...
                case PackageManager_1.PackageManager.Yarn:
                    path = child_process_1.execSync("yarn global dir").toString().trim();
                    break;
    ...
    LoadLibrary(filePath) {
        var _a, _b, _c;
        (_a = this.RunnerLogger) === null || _a === void 0 ? void 0 : _a.Log("LoadLibrary", `Trying to load \`${Constants_1.Constants.ESLintPackageName}\` for '${filePath}'`);
        /**
        ...
        if (esLintPath.length === 0) {
            (_b = this.RunnerLogger) === null || _b === void 0 ? void 0 : _b.Log("LoadLibrary", `The \`${Constants_1.Constants.ESLintPackageName}\` module could not be found!`);
            return () => null;
        }
        else {
            (_c = this.RunnerLogger) === null || _c === void 0 ? void 0 : _c.Log("LoadLibrary", `Resolves \`${Constants_1.Constants.ESLintPackageName}\` to '${esLintPath}'`, LogLevel_1.LogLevel.Verbose);
            // eslint-disable-next-line deprecation/deprecation
            return () => {
                // eslint-disable-next-line deprecation/deprecation
                let linter;
    ...
    ResolveESLint(nodePath, cwd) {
        ...
        let app = [
            ...
            try
            {
                console.log(require.resolve('${Constants_1.Constants.ESLintPackageName}'));
            }
            catch
            {
                console.log("");
